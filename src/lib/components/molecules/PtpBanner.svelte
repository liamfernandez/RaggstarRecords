...
{#if visible}
	<div
		...
		class="relative flex items-center gap-x-6 overflow-hidden bg-gradient-to-r from-[#ff80b5] to-[#9089fc] px-6 py-2.5 sm:px-3.5 sm:before:flex-1"
	>
		<div
		...
		>
			<div
				class="aspect-[577/310] w-[36.0625rem] opacity-30"
		...
		<div class="flex flex-wrap items-center gap-x-4 gap-y-2">
			<p class="text-sm/6 text-gray-900">
				<strong class="font-semibold">Pass the Peace - Open Mic</strong><svg
					viewBox="0 0 2 2"
			...
			<a
				...
				>RSVP Here <span aria-hidden="true">&rarr;</span></a
			>
		</div>
