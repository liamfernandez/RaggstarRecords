<script>
import BlogPageTemplate from '$lib/components/BlogPageTemplate.svelte';
</script>


<BlogPageTemplate>

# No Label? No Problem: How to Build a Fanbase as an Independent Artist

![Artist jumping into crowd backwards trying to crowd surf]({'/blog_image1.png'})
